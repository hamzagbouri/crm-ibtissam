...
import {
  ...
  getCollaborators as getCollaboratorsApi,
  addNewCollaborator as addNewCollaboratorApi,
  updateCollaborator as updateCollaboratorApi,
...
export const getCollaborators =  createAsyncThunk("crm/getCollaborators", async () => {
  try {
...
export const addNewCollaborator = createAsyncThunk(
  "crm/addNewCollaborator",
  async (collaborator) => {
    try {
      const response = addNewCollaboratorApi(collaborator);
      toast.success("Collaborator Added Successfully", { autoClose: 3000 });
      return response;
    } catch (error) {
      toast.error("Collaborator Added Failed", { autoClose: 3000 });
      return error;
    }
  }
);
...
export const updateCollaborator = createAsyncThunk(
  "crm/updateCollaborator",
  async (collaborator) => {
    try {
      const response = updateCollaboratorApi(collaborator);
      toast.success("Collaborator Updated Successfully", { autoClose: 3000 });
      return response;
    } catch (error) {
      toast.error("Collaborator Updated Failed", { autoClose: 3000 });
      return error;
    }
  }
);
...
export const deleteCollaborator = createAsyncThunk(
  "crm/deleteCollaborator",
  async (collaborator) => {
    try {
      const response = deleteCollaboratorApi(collaborator);
      toast.success("Collaborator Deleted Successfully", { autoClose: 3000 });
      return { collaborator, ...response };
    } catch (error) {
      toast.error("Collaborator Deleted Failed", { autoClose: 3000 });
      return error;
    }
  }
);
