...
// CRM
// get Collaborators
export const getCollaborators = () => api.get(url.GET_COLLABORATORS); 

// get Contacts
export const getContacts = () => api.get(url.GET_CONTACTS);

// add Collaborators
export const addNewCollaborator = collaborator => api.create(url.ADD_NEW_COLLABORATOR, collaborator);

// update Collaborators
export const updateCollaborator = collaborator => api.update(url.UPDATE_COLLABORATOR + '/' + collaborator._id, collaborator);

// delete Collaborators
export const deleteCollaborator = collaborator => api.delete(url.DELETE_COLLABORATOR + '/' + collaborator);
