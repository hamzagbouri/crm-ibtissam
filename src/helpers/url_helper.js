...
// CRM
// Collaborators
export const GET_COLLABORATORS = "/apps/collaborator";
export const ADD_NEW_COLLABORATOR = "/apps/collaborator";
export const UPDATE_COLLABORATOR = "/apps/collaborator";
export const DELETE_COLLABORATOR = "/apps/collaborator";
